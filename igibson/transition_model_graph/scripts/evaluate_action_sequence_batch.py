...
from igibson.transition_model_graph.scripts.evaluate_action_sequence import evaluate_action_seqeunce
import  os
import json
...
def main(demo_dir,action_dir,rst_dir,headless=True):
    ...
    for args in args_list:
        ...
        summary["success_rate"]=summary["success_steps"]/summary["total_steps"] if summary["total_steps"]>0 else 0
