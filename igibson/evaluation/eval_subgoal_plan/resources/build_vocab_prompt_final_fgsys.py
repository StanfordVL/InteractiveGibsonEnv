...
- You must output concrete states and do not use quantifiers like "forall" or "exists".
- The format must strictly follow this json format: {"output": [<your subgoal plan>]}, where <your subgoal plan> is a list of Boolean expressions.
- Your job is to generate the subgoal plan for the given task. Therefore, you must follow the data format by directly outputting the json data without any additional information. Otherwise, we CANNOT evaluate your output!
- Your output must start with the character "{" and end with the character "}".
'''
...
- The format must strictly follow this json format: {"output": "<your subgoal plan>"}, where <your subgoal plan> is a list of Boolean expressions. Start your output with "{" and end with "}".
'''
...
## Output: Based on initial states in this task, achieve final goal states logically and reasonably. It does not matter which state should be satisfied first, as long as all goal states can be satisfied at the end. Output concrete states and do not use quantifiers like "forall" or "exists". Make sure your output follows the json format, and do not include irrelevant information, do not include any explanation.
...
## Output: Based on initial states, achieve final goal states logically and reasonably. It does not matter which state should be satisfied first, as long as all goal states can be satisfied at the end. Output concrete states and do not use quantifiers like "forall" or "exists". Make sure your output follows the json format, and do not include irrelevant information, do not include any explanation.'''
