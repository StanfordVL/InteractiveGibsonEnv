(define (problem cleaning_freezer)
    ...
    (:goal (and (not (stained electric_refrigerator_n_01_1)) (not (inside food_n_01_3 electric_refrigerator_n_01_1)) (not (inside food_n_01_2 electric_refrigerator_n_01_1)) (not (inside food_n_01_1 electric_refrigerator_n_01_1))))
)