(define (problem preserving_food)
    ...
    (:goal (and (inside strawberry_n_01_2 jar_n_01_1) (cooked strawberry_n_01_1) (sliced strawberry_n_01_1) (inside strawberry_n_01_1 jar_n_01_1) (cooked strawberry_n_01_2) (sliced strawberry_n_01_2)))
)