(define (problem polishing_silver)
    ...
    (:goal (and (not (dusty spoon_n_01_1)) (inside spoon_n_01_3 cabinet_n_01_1) (inside spoon_n_01_2 cabinet_n_01_1) (inside spoon_n_01_1 cabinet_n_01_1) (not (dusty spoon_n_01_2)) (inside spoon_n_01_4 cabinet_n_01_1)))
)